...
#valueはリストを使用：1つのロッカーの中身を被っていても変動することもあるためリストを使用する
#lockerはタプルを使用：lockerの中身はkeyとvalueだけなので変更や削除がいらないため　→　ディクショナリーを使用31行目をvalueで表せるようになる
